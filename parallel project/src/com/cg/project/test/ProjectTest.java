...
*/
		...
		@Test
		public void testDepositeForMobileNoDoesNotExist() {
			Account ac = new Account();
		...
		public void testWithdrawAmt() {
			...
			assertEquals("The amount to be withdraw should be less than available balance ang greater than zero", e.getMessage());
			}
		}
		@Test
		...
		public void testFundTransferForAmt() {
			...
			assertEquals("The amount to be withdraw should be greater than available balance and greater than zero", e.getMessage());
			}
		}
		@Test
